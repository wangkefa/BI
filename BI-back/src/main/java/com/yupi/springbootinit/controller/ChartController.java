...
// 把返回值改成BiResponse
    public BaseResponse<BiResponse> genChartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        //检验
        ThrowUtils.throwIf(!validFileSuffixList.contains(suffix),ErrorCode.PARAMS_ERROR,"不支持此格式文件");
...
//        chart.setChartData(csvData);
        chart.setChartData(RandomUtil.randomNumbers(19));
...
//        chart.setGenResult(genResult);
        ...
        CompletableFuture.runAsync(() -> {
            ...
            // 调用 AI
            String result = aiManager.doChat(CommonConstant.BI_MODE_ID, userInput.toString());
            String[] splits = result.split("【【【【【");
            if (splits.length < 3) {
